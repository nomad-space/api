...
<body dir="{{.Hermes.TextDirection}}">
  <table class="email-wrapper" style="
      width: 100%;
      margin: 0;
      padding: 0;
      background-color: #2c3e50;" width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td class="content">
			  ...
			  <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell" style="padding: 35px;">
					  <a class="email-masthead_name" style="font-size: 16px;
      font-weight: bold;
      color: #2F3133;
      text-decoration: none;
      text-shadow: 0 1px 0 white;" href="{{.Hermes.Product.Link}}" target="_blank">
						{{ if .Hermes.Product.Logo }}
						  <img src="{{.Hermes.Product.Logo | url }}" alt="{{.Hermes.Product.Name }}" class="email-logo" />
						{{ else }}
						  {{ .Hermes.Product.Name }}
						{{ end }}
					  </a>
                          ...
                          {{ range $action := . }}
                            ...
                            <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center">
                                  <div>
                                    <a href="{{ $action.Button.Link }}" class="button" style="background-color: {{ $action.Button.Color }}; display: inline-block;
      width: 100%;
      color: #ffffff;
      font-size: 15px;
      line-height: 45px;
      ...
      table-layout: fixed;">
                          <tbody>
                              {{ range $action := . }}
                                <tr>
                                  <td>
                                    <p class="sub" style="font-size: 12px;">{{$.Hermes.Product.TroubleText | replace "{ACTION}" $action.Button.Text}}</p>
                                    <p class="sub" style="font-size: 12px;"><a href="{{ $action.Button.Link }}">{{ $action.Button.Link }}</a></p>
                                  </td>
                                </tr>
                              {{ end }}
                          </tbody>
          ...
          <tr>
            <td>
              <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-cell" style="padding: 35px;">
                    <p class="sub center" style="text-align: center; font-size: 12px;">
